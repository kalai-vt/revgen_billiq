...
export const NAV_ENTRIES: NavEntry[] = [
  ...
  { to: '/customers', label: 'Customers', icon: Users, roles: ['owner', 'manager', 'staff'], moduleKey: 'customers' },
  {
    ...
    icon: Truck,
    children: [
      { to: '/procurement/dashboard', label: 'Dashboard', icon: LayoutDashboard, roles: ['owner', 'manager'], moduleKey: 'procurement' },
      { to: '/procurement/vendors', label: 'Vendors', icon: Truck, roles: ['owner', 'manager', 'staff'], moduleKey: 'vendors' },
      { to: '/procurement/purchases', label: 'Purchase Entry', icon: PackagePlus, roles: ['owner', 'manager', 'staff'], moduleKey: 'purchase_entries' },
      { to: '/procurement/returns', label: 'Purchase Returns', icon: Undo2, roles: ['owner', 'manager', 'staff'], moduleKey: 'purchase_returns' },
      { to: '/procurement/vendor-payments', label: 'Vendor Payments', icon: Wallet, roles: ['owner', 'manager', 'staff'], moduleKey: 'vendor_payments' },
      { to: '/procurement/analytics', label: 'Procurement Analytics', icon: TrendingUp, roles: ['owner', 'manager'], moduleKey: 'procurement_analytics' },
      { to: '/procurement/reports', label: 'Procurement Reports', icon: ClipboardList, roles: ['owner', 'manager'], moduleKey: 'procurement_reports' },
    ],
  },
  {
    label: 'Commerce',
    icon: ShoppingBag,
    children: [
      { to: '/commerce/dashboard', label: 'Dashboard', icon: LayoutDashboard, roles: ['owner', 'manager'], moduleKey: 'commerce_analytics' },
      { to: '/commerce/swiggy', label: 'Swiggy', icon: UtensilsCrossed, roles: ['owner', 'manager'], moduleKey: 'commerce_swiggy' },
      { to: '/commerce/zomato', label: 'Zomato', icon: Store, roles: ['owner', 'manager'], moduleKey: 'commerce_zomato' },
      { to: '/commerce/orders', label: 'Orders', icon: ShoppingBag, roles: ['owner', 'manager', 'staff'], moduleKey: 'commerce' },
      { to: '/commerce/product-mapping', label: 'Product Mapping', icon: PackageSearch, roles: ['owner', 'manager'], moduleKey: 'commerce' },
    ],
  },
  {
    label: 'Analytics',
