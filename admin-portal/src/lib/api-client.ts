// Distinct localStorage keys from the Billing app's (revgeniq_access_token/revgeniq_refresh_token)
// so admin and tenant-user sessions never collide, even if both apps are ever opened in the same
// browser profile.
const ACCESS_TOKEN_KEY = 'revgeniq_admin_access_token';
const REFRESH_TOKEN_KEY = 'revgeniq_admin_refresh_token';
