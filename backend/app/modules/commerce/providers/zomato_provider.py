...
_NOT_AVAILABLE = (
    "Zomato live API integration requires Zomato's POS-partner approval (a business/legal "
...
class ZomatoProvider(CommerceProvider):
    """Structural stub matching CommerceProvider — implement each method against Zomato's real
