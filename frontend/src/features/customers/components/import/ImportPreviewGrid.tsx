...
import type { ImportRow } from '@/features/customers/api';
...
export function ImportPreviewGrid({ importId, rows, onRowsChange }: ImportPreviewGridProps) {
  ...
  const columnDefs = useMemo<ColDef<ImportRow>[]>(
    () => [
      ...
      { field: 'mobile', headerName: 'Mobile', width: 130, minWidth: 130, editable: true },
      { field: 'email', headerName: 'Email', width: 180, minWidth: 180, editable: true },
      { field: 'address', headerName: 'Address', flex: 1, minWidth: 160, editable: true },
      {
        field: 'status',
        headerName: 'Status',
        width: 100,
